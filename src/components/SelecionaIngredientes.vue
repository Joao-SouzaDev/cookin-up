<script lang="ts">
import { obterCategrias } from '@/http/index';
...
export default {
    ...
    async created(){
        this.categorias = await obterCategrias();
    },
    components: {
        CardCategoria, BotaPrincipal
    },
...
<template>
    ...
    <BotaPrincipal :texto="'Buscar Receitas!'" @click="$emit('buscarReceitas')"/>
</template>
